...
export default function CommentItem({ comment, authUserId }: { comment: Comment; authUserId: number }) {
    ...
    return (
        <div className="flex items-start space-x-3 border-b border-gray-200 py-4 dark:border-gray-700">
            {/* User Avatar */}
            ...
            <div className="flex-1">
                <div className="flex items-center justify-between">
                    ...
                    {authUserId === comment.user.id && can(user, 'manage_comments') && (
                        <button onClick={handleDelete} className="text-red-500 transition hover:text-red-700" title="Delete comment">
                            <svg
                   ...
                   a2.25 2.25 0 0 1-2.244 2.077H8.084a2.25 2.25 0 0 
                ...
                <p className="mt-1 text-gray-800 dark:text-gray-200">{comment.comment}</p>
            </div>
        </div>
    );
}
